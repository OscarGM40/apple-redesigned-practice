...
const Success = ({ products }: Props) => {
  ...
  // en mobiles depende del state,en mayores screeens es siempre true(muy habil aqui, pudiendo ser condicional o no)
  const showOrderSummaryCondition = isTabletOrMobile ? showOrderSummary : true;

  const subtotal = products.reduce((acc: any, product) => {
  ...
  return (
    <div>
      ...
      <header className="mx-auto max-w-xl">
        <Link href="/">
          <div className="relative ml-4 h-16 w-8 cursor-pointer transition lg:hidden mt-2">
            <Image
      ...
      <main className="grid grid-cols-1 lg:grid-cols-9">
        <section className="order-1 mx-auto max-w-xl pb-12 lg:col-span-5 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44">
          <Link href="/">
          ...
          <div className="my-6 ml-4 flex space-x-4 lg:ml-14 ">
          ...
          <div className="mx-4 divide-y divide-gray-300 rounded-md border border-gray-300 p-4 lg:ml-14">
            <div className="space-y-2 pb-3">
              ...
              <p className="text-sm text-gray-600">{`(This is just a simulation)  We've accepted your order, and we're getting it ready. Come back to this page for updates on your shipment status`}</p>
            </div>
...
export const getServerSideProps: GetServerSideProps<Props> = async (ctx) => {
  // recuerda que tengo acceso a los queryParams desde el context.query[paramName]
